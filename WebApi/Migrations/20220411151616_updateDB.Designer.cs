...
namespace WebApi.Migrations
{
    ...
    [Migration("20220411151616_updateDB")]
            ...
            modelBuilder.Entity("WebApi.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Lastname = "Pendlebery",
                            Location = "Hochiminh",
                            PasswordHash = "$2a$11$haLE2d4P4VlNLoFXai.kn.E8J.QA2mDiN81bw2MsO/PTifkKZC5Jy",
                            StaffCode = "SD0001",
                            Type = 0,
                            Username = "edp"
                        },
                        new
                        {
                            ...
                            Lastname = "O'Loinn",
                            Location = "Hochiminh",
                            PasswordHash = "$2a$11$dOrMn0kNh0uSv2V.ns8VFOm/PUvBWk8sUZpT.1Pn80bT9U2XXsTPi",
                            StaffCode = "SD0002",
                            Type = 1,
                            Username = "courtneyo"
                        },
                        new
                        {
                            ...
                            Lastname = "Renahan",
                            Location = "Hanoi",
                            PasswordHash = "$2a$11$qpp7XZeUNXwMH3tXFsGm.O4EXDCHReMoL9.huvh0fO12FHg8etIuu",
                            StaffCode = "SD0003",
                            Type = 0,
                            Username = "eudorar"
                        },
                        new
                        {
                            ...
                            Lastname = "Hugueville",
                            Location = "Hochiminh",
                            PasswordHash = "$2a$11$J/.Zl6KRgEYY7OgDRRQbgu6phOn9tMgtWE3akuL5QYqQjmTEvCgcG",
                            StaffCode = "SD0004",
                            Type = 1,
                            Username = "bevinh"
                        },
                        new
                        {
                            ...
                            Lastname = "Broadis",
                            Location = "Hochiminh",
                            PasswordHash = "$2a$11$s1M/GhfXDogB8RU/RgRJKet1.DdPW6byKe3Os.LTE9LckjH8UVEjy",
                            StaffCode = "SD0005",
                            Type = 1,
                            Username = "andrewb"
                        },
                        new
                        {
                            ...
                            Lastname = "Zecchi",
                            Location = "Hanoi",
                            PasswordHash = "$2a$11$z7DTOR8axJVxT/hYwD1i3.hVkUHlXCU82ND9ZpeYmX4ZsjefTp3nW",
                            StaffCode = "SD0006",
                            Type = 1,
                            Username = "tadesz"
                        },
                        new
                        {
                            ...
                            Lastname = "Huson",
                            Location = "Hochiminh",
                            PasswordHash = "$2a$11$Db.jnOCDntyN0/r25FmbM.09jajApmQ/fqNOa6MOr.N6VHExejH7S",
                            StaffCode = "SD0007",
                            Type = 1,
                            Username = "vernorh"
                        },
                        new
                        {
                            ...
                            Lastname = "Yole",
                            Location = "Hochiminh",
                            PasswordHash = "$2a$11$t4B.fArl8qr.Mh3bq7XYAO4nErIcHIcTNDUliBbB3u3AYKjXag0cW",
                            StaffCode = "SD0008",
                            Type = 1,
                            Username = "rufey"
                        },
                        new
                        {
                            ...
                            Lastname = "Woodyear",
                            Location = "Hochiminh",
                            PasswordHash = "$2a$11$7GZn2cvVsCNSLzAOqd0tb.XCmzcadYHK/sv20u/UzPTiPgRqA/Ol6",
                            StaffCode = "SD0009",
                            Type = 1,
                            Username = "ortonw"
                        },
                        new
                        {
                            ...
                            Lastname = "Carmichael",
                            Location = "Hochiminh",
                            PasswordHash = "$2a$11$TzBT2yaJey7vFHzzrn38rOgq4zIBQ3OsQwcVRjjDmeE0ZAY18zQ42",
                            StaffCode = "SD0010",
                            Type = 1,
                            Username = "peyterc"
                        },
                        new
                        {
                            ...
                            Lastname = "Pitchers",
                            Location = "Hanoi",
                            PasswordHash = "$2a$11$zDtmeFIUgRVHzdxbQ5PU0OFPLIjG6DcHmQFy0tnH/XJduJXe/2Hr.",
                            StaffCode = "SD0011",
                            Type = 1,
                            Username = "kathyp"
                        },
                        new
                        {
                            ...
                            Location = "Hochiminh",
                            PasswordHash = "$2a$11$mSeRjjFGGCMCLsfv4MrDj.Mx4SmgnU0ht3z0XUqQjBuIq06Icc8Xi",
                            StaffCode = "SD0012",
                            Type = 1,
                            Username = "beaut"
                        });
